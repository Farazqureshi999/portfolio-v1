    ...
    return <div className="section" id="aboutme">
        ...
        <div className="content-inner">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-4">
                <div >
                    <p className="text-xl sm:text-1xl lg:text-2xl font-normal mb-4 lg:mb-8 font-nunito">I’m a Front-End Developer
                    ...
                    <p className="text-xl sm:text-1xl lg:text-2xl font-normal mb-4 lg:mb-8 font-nunito">Well- Organized person,
                    ...
                    <p className="text-xl sm:text-1xl lg:text-2xl font-normal mb-4 lg:mb-8 font-nunito">Interested in the entire
                        frontend spectrum and working on ambitious project with positive people.</p>
                    <p className="text-xl sm:text-1xl lg:text-2xl font-normal mb-4 lg:mb-8 font-nunito">Lets make something special.</p>
